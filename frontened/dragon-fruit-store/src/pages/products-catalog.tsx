...
export default function ProductsCatalog() {
  ...
  const filtered = useMemo(() => {
    return productsList.filter((p: any) => {
      ...
      const matchFilter =
        activeFilter === "All" ||
        (activeFilter === "Featured" && Boolean(p?.featured)) ||
  ...
  }, [productsList, search, activeFilter]);
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-wrap justify-center gap-8 md:gap-16">
            {[
              ...
              { icon: <Leaf className="w-5 h-5" />, text: "Prepaid Orders Only" },
            ].map((t) => (
      ...
      <OrderFormDialog
        ...
        description="Fill in your details and continue on WhatsApp with this product order."
      />
    </div>
  );
}
